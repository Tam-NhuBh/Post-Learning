    ...
    public class PostBLL
    {
        ...
        public bool AddComment(GeneralDTO model)
        {
           Comment comment = new Comment();
            ...
            comment.CommnentContent = model.Message;
        ...
        void SavePostImage(List<PostImageDTO> list, int PostID)
        {
            ...
            foreach (var item in imagelist)
            {
                ...
                LogDAO.AddLog(General.ProcessType.PostAdd, General.TableName.Image, imageID);
            }
        }
        ...
        public PostDTO GetPostWithID(int ID)
        {
            ...
            List<PostTag> taglist = dao.GetPostTagWidthPostID(ID);
            string tagvalue = "";
            foreach (var item in taglist)
            {
        ...
        {
            string imagepath = dao.DeleteSPostImage(ID);
