...
namespace UI.Areas.Admin.Controllers
{
    public class UserController : BaseController
    {
        ...
        {
            UserDTO dto = bll.GetUserWithID(ID); ;
           return View(dto);
        }
        [HttpPost]
        public ActionResult UpdateUser(UserDTO model )
        {
            ...
            else
            {
                ...
                if(model.UserImage != null)
                {
                    if (System.IO.File.Exists(Server.MapPath("~/Area/Admin/Content/UserImage/" + oldImagePath)))
                    {
                        System.IO.File.Delete(Server.MapPath("~/Area/Admin/Content/UserImage/" + oldImagePath));
                    }
